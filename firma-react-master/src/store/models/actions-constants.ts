const actionsConstants = {
    ...
    SET_APPEALS_LIST: 'SET_APPEALS_LIST',
    SORT_APPEALS_LIST: 'SORT_APPEALS_LIST',
    SET_CLIENT_APPEALS_LIST: 'SET_CLIENT_APPEALS_LIST',
    SET_THEMES_LIST: 'SET_THEMES_LIST',
    SET_TNVED_LIST: 'SET_TNVED_LIST',
    SET_STAFFS_LIST: 'SET_STAFFS_LIST',
    SET_CAT_COST_LIST: 'SET_CAT_COST_LIST',
}

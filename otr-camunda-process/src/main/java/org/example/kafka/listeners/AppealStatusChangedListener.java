...
public class AppealStatusChangedListener {
    ...
    public void appealCreatedCommandReceived(String messageJson) throws JsonParseException, JsonMappingException, IOException {
        ...
        Message<AppealStatusChangedDto> message = objectMapper.readValue(
                messageJson,
                new TypeReference<Message<AppealStatusChangedDto>>(){}
        );

        appealService.changeStatus(message.getData());
    }
